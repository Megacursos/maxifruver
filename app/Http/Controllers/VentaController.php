...
class VentaController extends Controller
{
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            ->where('ventas.num_venta','LIKE','%'.$query.'%')
    ...
    public function store (Request $request)
    {
    	try{
            ...
            $venta->tipo_identificacion = $request->get('tipo_identificacion');
            $venta->num_venta = $request->get('num_venta');
    ...
    public function show($id)
    {
        ...
        ->select('detalle_ventas.cantidad','detalle_ventas.unidad','detalle_ventas.precio','detalle_ventas.descuento','productos.nombre as producto')
    ...
    {
        $venta = Venta::findOrFail($request->get('id_venta'));
    ...
    public function pdf(Request $request,$id){
        ...
        $detalles = DetalleVenta::join('productos','detalle_ventas.idproducto','=','productos.id')
        ->select('detalle_ventas.cantidad','detalle_ventas.unidad','detalle_ventas.precio','detalle_ventas.descuento',
        ...
        $pdf= \PDF::loadView('reportes.venta',['venta'=>$venta,'detalles'=>$detalles]);
